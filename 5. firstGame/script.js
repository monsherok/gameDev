...
class Raven {
    ...
    update(deltaTime) {
        ...
        this.timeSeiceFlap += deltaTime
        if (this.timeSeiceFlap > this.flapInterval) {
...
class Explosion {
    ...
    update(deltatime) {
        ...
        this.timeSeiceLastFrame += deltatime;
        if (this.timeSeiceLastFrame > this.frameInterval) {
            this.frame++;
            this.timeSeiceLastFrame = 0;
            if (this.frame > 5) {
